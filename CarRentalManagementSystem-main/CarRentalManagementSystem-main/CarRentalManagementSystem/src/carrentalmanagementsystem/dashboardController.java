...
public class dashboardController implements Initializable {
    ...
    @FXML
    void openSettingsPage(ActionEvent event) throws IOException {
...
//     THANKS FOR THE SUPPORT GUYS!
    ...
    // Load the FXML file for the settings page
    ...
    try {
        ...
        // Set a listener to handle when the settings window is closed
        stage.setOnHidden(event -> {
            // Actions to perform when the settings window is closed
            // For example, update data or refresh the dashboard
            System.out.println("Settings window closed. Refreshing dashboard...");
        });

        // Show the settings page in a new window
        stage.show();
    } catch (IOException e) {
        e.printStackTrace();
    }
